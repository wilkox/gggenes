...
-1, the gene will be drawn in the reverse of this implied direction:
...
Both of these geoms take an optional `forward` aesthetic to indicated whether a
feature is oriented and, if so, in what direction (`TRUE` meaning oriented
towards the right of the x-axis and `FALSE` meaning towards the left).
