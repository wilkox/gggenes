...
- [`example_dummies`](https://wilkox.org/gggenes/dev/reference/example_dummies.md)
  : A set of example dummy alignment genes.
- [`example_features`](https://wilkox.org/gggenes/dev/reference/example_features.md)
  [`example_features_polar`](https://wilkox.org/gggenes/dev/reference/example_features.md)
  : A set of example genetic features.
- [`example_genes`](https://wilkox.org/gggenes/dev/reference/example_genes.md)
  [`example_genes_polar`](https://wilkox.org/gggenes/dev/reference/example_genes.md)
  [`example_subgenes`](https://wilkox.org/gggenes/dev/reference/example_genes.md)
  [`example_subgenes_polar`](https://wilkox.org/gggenes/dev/reference/example_genes.md)
  : A set of example genes.
- [`example_terminators`](https://wilkox.org/gggenes/dev/reference/example_terminators.md)
  [`example_terminators_polar`](https://wilkox.org/gggenes/dev/reference/example_terminators.md)
...
- [`make_alignment_dummies()`](https://wilkox.org/gggenes/dev/reference/make_alignment_dummies.md)
  : Prepare dummy data to visually align a single gene across faceted
  molecules
- [`theme_genes()`](https://wilkox.org/gggenes/dev/reference/theme_genes.md)
  [`theme_genes_flipped()`](https://wilkox.org/gggenes/dev/reference/theme_genes.md)
