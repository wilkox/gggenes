...
Prior to version 0.6.0.9001, `linewidth` in
...
was expressed in points, not millimetres, with a default value of 1.
This was inconsistent with both
...
![](reference/figures/README-geom_gene_arrow-1.png)
...
![](reference/figures/README-theme_genes-1.png)
...
![](reference/figures/README-make_alignment_dummies-1.png)
...
[`geom_gene_label()`](https://wilkox.org/gggenes/reference/geom_gene_label.md)
uses the [ggfittext](https://github.com/wilkox/ggfittext) package to fit
...
![](reference/figures/README-labelled_genes-1.png)
...
![](reference/figures/README-reversing_direction-1.png)
...
![](reference/figures/README-subgenes-1.png)
...
![](reference/figures/README-subgene_labels-1.png)
...
We can draw and label transcription terminators with
[`geom_terminator()`](https://wilkox.org/gggenes/reference/geom_terminator.md)
and
