...
makeContent.assemblyscartree <- function(x) {
  ...
  grobs <- lapply(seq_len(nrow(data)), function(i) {
    ...
    # Generate the polygon. assembly_scar_alongs and assembly_scar_aways are
    # internal data generated by data-raw/prepare_coordinates.R
    alongs <- c(assembly_scar$along_min, assembly_scar$along_max,
                assembly_scar$along_max, assembly_scar$along_min)
    aways <- assembly_scar$away + (awayness * assembly_scar_aways)
    indices <- c(1, 1, 2, 2)
