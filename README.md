...
[![R-CMD-check](https://github.com/wilkox/gggenes/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/wilkox/gggenes/actions/workflows/R-CMD-check.yaml)
...
gggenes can draw in polar coordinates by adding `coord_polar()` to the
plot.
